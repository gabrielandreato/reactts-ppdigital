            ...
            <div className={styles.Header}>
                <SubNavBar>
                    ...
                    <li className={styles.NavFunctions}>
                        <FilterCoursesByResponsability />
                        <BotaoNavBar onClick={() => navigate('/pagina-principal/formulario-curso-cargo')}>
                            <i className={`bi bi-plus-square ${styles.SubNavButtonIcon}`}></i>Cadastrar Curso
                        </BotaoNavBar>
                    </li>
                </SubNavBar>
            </div>
